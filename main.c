...
======================================================================*/
static void write_to_file(const char *filename, const char *text) {
...
/*======================================================================
  export_pin
======================================================================*/
static void export_pin(int pin, const char *direction, int initial_value) {
    ...
    if(!strcmp(INPUT, direction)) {
        ...
        write_to_file(buffer, INPUT_EDGE);
...
/*======================================================================
  unexport_pin
======================================================================*/
static void unexport_pin(int pin) {
    char buffer[BUFFER_SIZE] = {0};
...
/*======================================================================
  open_inputs
======================================================================*/
static void open_inputs(struct pollfd *fdset) {
    char filename[BUFFER_SIZE] = {0};
    int fd;
...
/*======================================================================
  close_inputs
======================================================================*/
static void close_inputs(struct pollfd *fdset) {
    for(int i = 0; i < n_input_pins; ++i) {
...
======================================================================*/
static void quit_signal(int dummy) {
    running = 0;
}
...
======================================================================*/
static long current_timestamp(void) {
    struct timeval tv;
...
======================================================================*/
static void handle_button(int pin, long msec) {
...
int main(void) {
    ...
    while(running) {
        ...
        if(poll(fdset, n_input_pins, POLL_TIMEOUT)) {
            for(int i = 0; i < n_input_pins; ++i) {
